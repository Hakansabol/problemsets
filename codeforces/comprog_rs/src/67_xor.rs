...
// if the number of items remaining is *even* then the xor works otherwise it can be ignored
// so, we can simply select half of the items rounded down plus one (the last element) and xor them.
